...
public enum Ranking {
    ...
    RANKING_TWO(5, true, 30_000_000, "6개 일치 (30,000,000원) - %d개"),
    RANKING_THREE(5, false, 1_500_000, "6개 일치 (1,500,000원) - %d개"),
    RANKING_FOUR(4, false, 50_000, "6개 일치 (50,000원) - %d개"),
    RANKING_FIVE(3, false, 5_000, "6개 일치 (5,000원) - %d개");
